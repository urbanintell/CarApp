...
class HomeViewController: UIViewController, ARSCNViewDelegate,  MKMapViewDelegate, SceneLocationViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let pinCoordinate = CLLocationCoordinate2D(latitude: 33.7574, longitude: -84.4327)
        let pinLocation = CLLocation(coordinate: pinCoordinate, altitude: 234)
        let pinImage = UIImage(named: "arraw")!
